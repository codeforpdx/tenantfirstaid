...
│   ├── generate_referrals.py           # Generates the validated referral catalog bundled into the static frontend (run via `mise run generate-referrals` or `npm run generate-referrals`)
