      ...
      <div className="relative max-w-2xl m-auto p-8 bg-paper-background rounded-lg shadow-md">
        ...
        <PageSection title="Disclaimer" headingLevel={2}>
          <p>
            ...
            our "<span className="underline">Services</span>") provided by
            Tenant First Aid, a program by Qiu Qiu Law and Code PDX ("
            ...
            action waiver in Section 14, do not access or use our Services.
          </p>
          <p className="my-4">
        ...
        <PageSection title="1. Eligibility" headingLevel={3}>
          <p>
            ...
            access or use our Services. If you are under 18 years of age, you
            may only access or use our Services under the supervision of a
            parent or legal guardian who agrees to be bound by these Terms. If
            you are accessing or using our Services on behalf of another person
            or entity, you represent that you are authorized to accept these
            Terms on that person’s behalf and that the person agrees to be
            responsible to us if you or the other person or entity violates
            these Terms.
          </p>
        </PageSection>
        ...
        >
          ...
          <p>
            ...
            User Content and any name or likeness provided in connection with
            your User Content for the purpose of providing the Services to you
            or improving the Services, or to enable Tenant First Aid or its
            partner organizations to develop similar services, without
            compensation to you.
          </p>
          <p>
        ...
        >
          ...
          <ul className="list-disc list-outside pl-6">
            <li>
              ...
              suggestive, harassing, threatening, invasive of privacy or
            ...
            <li>
              Contains any statements, remarks or claims that do not reflect
            ...
            <li>
              ...
              or destructive files or content
            </li>
            <li>
              ...
              that may expose Tenant First Aid or others to any harm or
        ...
        >
          <p>
            ...
            owned by or licensed to Tenant First Aid and are protected under
            both United States and foreign laws. Except as explicitly stated in
            these Terms, Tenant First Aid and our licensors reserve all rights
            in and to our Services and the Tenant First Aid Content. You are
            hereby granted a limited, nonexclusive, nontransferable,
            non-sublicensable, revocable license to access and use our Services
            and Tenant First Aid Content for your own personal use; however,
            such license is subject to these Terms and does not include any
            right to (a) sell, resell or commercially use our Services or Tenant
            First Aid Content; (b) copy, reproduce, distribute, publicly perform
            or publicly display Tenant First Aid Content, except as expressly
            permitted by us or our licensors (which includes using the legal
            information provided through the services for the purpose of
            informing your approach to landlord/tenant disputes); (c) modify the
            Tenant First Aid Content or remove any proprietary rights notices or
            markings from Tenant First Aid Content; (d) use any data mining,
            robots or similar data gathering or extraction methods; and (e) use
            our Services or Tenant First Aid Content other than for their
            intended purposes. Any use of our Services or Tenant First Aid
            Content other than as specifically authorized herein, without our
            prior written permission, is strictly prohibited and will terminate
        ...
        <PageSection title="6. Feedback" headingLevel={3}>
          <p>
            ...
            <span className="underline">Feedback</span>"), is non-confidential
            and will become the sole property of Tenant First Aid. We will own
        ...
        <PageSection title="7. Information Not Legal Advice" headingLevel={3}>
          <p>
            ...
            licensed attorney. Although Tenant First Aid goes to great lengths
            to make sure the Tenant First Aid Content is accurate and up to
            date, we make no claim as to the accuracy of the Tenant First Aid
            Content and are not responsible for any consequences that may result
            from the use of the Services. We recommend that you consult with a
            licensed attorney if you want assurance that the information on the
            Services and your interpretation of it are appropriate for your
            particular situation. You should not and are not authorized to rely
            on the Services or Tenant First Aid Content as a source of legal
            advice. The use of the Services does not create an attorney-client
            relationship between you or any user and Qiu Qiu Law or any of its
            providers, partners or affiliated organizations.
          </p>
        </PageSection>
        ...
        <PageSection title="8. Indemnification" headingLevel={3}>
          <p>
            ...
            indemnify, defend, and hold harmless Tenant First Aid, Qiu Qiu Law,
            Code PDX, and its respective partners and affiliated organizations
            and each of our and their respective officers, directors, agents,
            partners and employees (individually and collectively, the "
            <span className="underline">Tenant First Aid Parties</span>") from
            and against any loss, liability, claim, demand, damages, expenses or
            costs ("
            <span className="underline">Claims</span>") arising out of or
            related to (a) your access to or use of our Services; (b) your User
            Content or Feedback; (c) your violation of these Terms; (d) your
            ...
            your conduct in connection with our Services. You agree to promptly
            notify us of any third party Claims, cooperate with the Tenant First
            Aid Parties in defending such Claims and pay all fees, costs and
            expenses associated with defending such Claims (including, but not
            limited to, attorneys’ fees). You also agree that the Tenant First
            Aid Parties will have control of the defense or settlement of any
            ...
            between you and Tenant First Aid or the other Tenant First Aid
            Parties.
          </p>
        </PageSection>
        ...
        >
          ...
          <p>
            ...
            make your access to and use of our Services safe, we cannot and do
            not represent or warrant that our Services or servers are free of
        ...
        >
          <p>
            ...
            punitive or special damages or lost profits, even if Tenant First
            Aid or the other Tenant First Aid Parties have been advised of the
            possibility of such damages.
          </p>
          <p>
            The total liability of Tenant First Aid and the other Tenant First
            Aid Parties, for any claim arising out of or relating to these Terms
            or our Services, regardless of the form of the action, is limited to
            the amount paid, if any, by you to access or use our Services.
          </p>
          <p>
            ...
            of Tenant First Aid or the other Tenant First Aid Parties or for any
        ...
        <PageSection title="11. Release" headingLevel={3}>
          <p>
            ...
            Tenant First Aid and the other Tenant First Aid Parties from
            ...
            third parties. You expressly waive any rights you may have under any
        ...
        <PageSection title="13. Electronic Communications" headingLevel={3}>
          <p>
            By creating a Tenant First Aid account or using the Services, you
            also consent to receive electronic communications from Tenant First
            Aid (e.g., via email, text or by posting notices on our Services).
            These communications may include notices about your account or
            reminders related to your use of the Services and are part of your
        ...
        >
          <p>
            ...
            to arbitrate certain disputes and claims with Tenant First Aid and
            limits the manner in which you can seek relief from us.
          </p>
          <p>
            Except for small claims disputes in which you or Tenant First Aid
            seek to bring an individual action in small claims court located in
            the county of your billing address or disputes in which you or
            Tenant First Aid seeks injunctive or other equitable relief for the
            alleged unlawful use of intellectual property, you and Tenant First
            Aid waive your rights to a jury trial and to have any dispute
            arising out of or related to these Terms or our Services resolved in
            court. Instead, all disputes arising out of or relating to these
            Terms or our Services will be resolved through confidential binding
            arbitration held in Multnomah County, Oregon in accordance with the
            Streamlined Arbitration Rules and Procedures ("
            <span className="underline">Rules</span>") of the Judicial
            Arbitration and Mediation Services ("
            <span className="underline">JAMS</span>"), which are available on
            the JAMS website and hereby incorporated by reference. You either
            acknowledge and agree that you have read and understand the rules of
            JAMS or waive your opportunity to read the rules of JAMS and any
          ...
          <p>
            ...
            prohibited by these Terms. The arbitrator may only conduct an
            ...
            more than one individual. You agree that for any arbitration you
            initiate, you will pay the filing fee and we will pay the remaining
            JAMS fees and costs. For any arbitration initiated by us, we will
            pay all JAMS fees and costs. You and Tenant First Aid agree that the
            state or federal courts of the State of Illinois and the United
            States sitting in Multnomah County, Oregon have exclusive
          ...
          <p className="font-semibold">
            ...
            CLAIM IS PERMANENTLY BARRED, WHICH MEANS THAT YOU AND TENANT FIRST
            AID WILL NOT HAVE THE RIGHT TO ASSERT THE CLAIM.
          </p>
          <p>
            You have the right to opt out of binding arbitration within thirty
            (30) days of the date you first accepted the terms of this Section
            14 by sending an email to{" "}
            <a
              href={`mailto:${CONTACT_EMAIL}`}
              className="underline text-blue-link hover:text-blue-dark"
              aria-label="contact-email"
            ...
            to resolve Disputes in accordance with this Section 14.
          </p>
        </PageSection>
        ...
        <PageSection title="15. Governing Law and Venue" headingLevel={3}>
          <p>
            ...
            of Oregon, without regard to conflict of law rules or principles
            ...
            between the parties that is not subject to arbitration or cannot be
            heard in small claims court will be resolved in the state or federal
            courts of Oregon and the United States, respectively, sitting in
        ...
        <PageSection title="16. Changes to these Terms" headingLevel={3}>
          <p>
            ...
            the “Last Updated” date above. Unless we say otherwise in our
            notice, the amended Terms will be effective immediately and your
            continued access to and use of our Services after we provide notice
            will confirm your acceptance of the changes. If you do not agree to
            the amended Terms, you must stop accessing and using our Services.
          </p>
        </PageSection>
        ...
        <PageSection title="20. Miscellaneous" headingLevel={3}>
          <p>
            ...
            provision of these Terms will not operate as a waiver of such right
