  ...
  return (
    <div className="relative max-w-2xl m-auto p-8 bg-paper-background rounded-lg shadow-md">
      ...
      <p>
        ...
        apply to your access to and use of the websites, chatbots, applications
        and other online products and services (collectively, our "
        <span className="underline">Services</span>") provided by Tenant First
        Aid, a program by Qiu Qiu Law and Code PDX ("
        ...
        Section 14, do not access or use our Services.
      </p>
      <p className="my-4">
      ...
      <p>
        You must be at least 18 years of age and a resident of Oregon to access
        or use our Services. If you are under 18 years of age, you may only
        access or use our Services under the supervision of a parent or legal
        guardian who agrees to be bound by these Terms. If you are accessing or
        using our Services on behalf of another person or entity, you represent
        that you are authorized to accept these Terms on that person’s behalf
        and that the person agrees to be responsible to us if you or the other
      ...
      <p>
        ...
        for information about how we collect, use and disclose information about
        you.
      </p>
      ...
      <p className="my-4">
        ...
        fully-paid, and sub-licensable license to use, reproduce, modify, adapt,
        translate, create derivative works from and distribute your User Content
        and any name or likeness provided in connection with your User Content
        for the purpose of providing the Services to you or improving the
        Services, or to enable Tenant First Aid or its partner organizations to
        develop similar services, without compensation to you.
      </p>
      <p>
        You may not create, post, store or share any User Content that violates
        these Terms or for which you do not have all the rights necessary to
        grant us the license described above. Although we have no obligation to
      ...
      <p>
        ...
        or other third-party right or commit a tort, and you are solely
        responsible for your conduct while accessing or using our Services. You
        will not:
      </p>
      ...
      <p className="my-4">
        You may also only upload User Content that you have all necessary rights
        to disclose. You may not create, or share any User Content that:
      </p>
      <ul className="list-disc list-outside my-4 pl-4">
        <li>
        ...
        <li>
          ...
          offense, violate the rights of any party or otherwise create liability
        ...
        <li>
          ...
          any other person from using or enjoying our Services, or that may
          expose Tenant First Aid or others to any harm or liability of any type
        </li>
      </ul>
      <h3 className="text-xl font-semibold my-4">
      ...
      <p>
        ...
        marks, logos, slogans and other content contained therein (collectively,
        the "<span className="underline">Tenant First Aid Content</span>") are
        ...
        our Services and the Tenant First Aid Content. You are hereby granted a
        limited, nonexclusive, nontransferable, non-sublicensable, revocable
        license to access and use our Services and Tenant First Aid Content for
        your own personal use; however, such license is subject to these Terms
        and does not include any right to (a) sell, resell or commercially use
        our Services or Tenant First Aid Content; (b) copy, reproduce,
        distribute, publicly perform or publicly display Tenant First Aid
        Content, except as expressly permitted by us or our licensors (which
        includes using the legal information provided through the services for
        the purpose of informing your approach to landlord/tenant disputes); (c)
        modify the Tenant First Aid Content or remove any proprietary rights
        notices or markings from Tenant First Aid Content; (d) use any data
        mining, robots or similar data gathering or extraction methods; and (e)
        use our Services or Tenant First Aid Content other than for their
        intended purposes. Any use of our Services or Tenant First Aid Content
      ...
      <p>
        ...
        materials or other information you submit about Tenant First Aid or our
        products or Services (collectively, "
        <span className="underline">Feedback</span>"), is non-confidential and
        will become the sole property of Tenant First Aid. We will own exclusive
        ...
        dissemination of Feedback for any purpose, commercial or otherwise,
      ...
      <p>
        The Services and Tenant First Aid Content provided through the Services
        are not legal advice. Legal information is not the same as legal advice,
        which is the application of law to an individual’s specific
        circumstances. The Tenant First Aid Services are not a substitute for
        and do not replace the advice or representation of a licensed attorney.
        Although Tenant First Aid goes to great lengths to make sure the Tenant
        First Aid Content is accurate and up to date, we make no claim as to the
        accuracy of the Tenant First Aid Content and are not responsible for any
        consequences that may result from the use of the Services. We recommend
        that you consult with a licensed attorney if you want assurance that the
        information on the Services and your interpretation of it are
        appropriate for your particular situation. You should not and are not
        authorized to rely on the Services or Tenant First Aid Content as a
        source of legal advice. The use of the Services does not create an
        attorney-client relationship between you or any user and Qiu Qiu Law or
        any of its providers, partners or affiliated organizations.
      </p>
      ...
      <p>
        ...
        its respective partners and affiliated organizations and each of our and
        ...
        ("
        <span className="underline">Claims</span>") arising out of or related to
        (a) your access to or use of our Services; (b) your User Content or
        ...
        connection with our Services. You agree to promptly notify us of any
        third party Claims, cooperate with the Tenant First Aid Parties in
        ...
        set forth in a written agreement between you and Tenant First Aid or the
        other Tenant First Aid Parties.
      </p>
      ...
      <p className="my-4">
        ...
        non-infringement. In addition, Tenant First Aid does not represent or
        warrant that our Services are accurate, complete, reliable, current or
        error-free. While Tenant First Aid attempts to make your access to and
        use of our Services safe, we cannot and do not represent or warrant that
      ...
      <p>
        ...
        First Aid Parties have been advised of the possibility of such damages.
      </p>
      <p className="my-4">
        ...
        Services, regardless of the form of the action, is limited to the amount
        paid, if any, by you to access or use our Services.
      </p>
      <p className="my-4">
        ...
        Tenant First Aid or the other Tenant First Aid Parties or for any other
      ...
      <p>
        ...
        users and the acts or omissions of third parties. You expressly waive
        any rights you may have under any statute or common law principles that
        would otherwise limit the coverage of this release to include only those
      ...
      <p className="my-4">
        ...
        county of your billing address or disputes in which you or Tenant First
        Aid seeks injunctive or other equitable relief for the alleged unlawful
        use of intellectual property, you and Tenant First Aid waive your rights
        to a jury trial and to have any dispute arising out of or related to
        these Terms or our Services resolved in court. Instead, all disputes
        arising out of or relating to these Terms or our Services will be
        ...
        understand the rules of JAMS or waive your opportunity to read the rules
        of JAMS and any claim that the rules of JAMS are unfair or should not
      ...
      <p className="my-4">
        ...
        9 U.S.C. § 1, et seq. (the "<span className="underline">FAA</span>"), to
        the maximum extent permitted by applicable law. As limited by the FAA,
        ...
        individual. You agree that for any arbitration you initiate, you will
        pay the filing fee and we will pay the remaining JAMS fees and costs.
        For any arbitration initiated by us, we will pay all JAMS fees and
        costs. You and Tenant First Aid agree that the state or federal courts
        of the State of Illinois and the United States sitting in Multnomah
        County, Oregon have exclusive jurisdiction over any appeals and the
      ...
      <p className="my-4">
        ...
        PERMANENTLY BARRED, WHICH MEANS THAT YOU AND TENANT FIRST AID WILL NOT
      ...
      <p className="my-4">
        ...
        opting out of binding arbitration, you are agreeing to resolve Disputes
      ...
      <p>
        ...
        by and construed and enforced in accordance with the laws of Oregon,
        without regard to conflict of law rules or principles (whether of Oregon
        or any other jurisdiction) that would cause the application of the laws
        of any other jurisdiction. Any dispute between the parties that is not
        subject to arbitration or cannot be heard in small claims court will be
        resolved in the state or federal courts of Oregon and the United States,
        respectively, sitting in Multnomah County, Oregon.
      </p>
      <h3 className="text-xl font-semibold my-4">16. Changes to these Terms</h3>
      <p>
        ...
        amended Terms will be effective immediately and your continued access to
        and use of our Services after we provide notice will confirm your
        acceptance of the changes. If you do not agree to the amended Terms, you
      ...
      <p>
        ...
        that apply to specific features, products or services. To the extent any
        additional terms conflict with these Terms, the additional terms govern
        with respect to your access to or use of the applicable feature, product
        or service.
      </p>
      ...
      <p>
        ...
        responsible for any loss or harm related to your inability to access or
        use our Services.
      </p>
      ...
      <p>
        These Terms constitute the entire agreement between you and Tenant First
        Aid relating to your access to and use of our Services. The failure of
        Tenant First Aid to exercise or enforce any right or provision of these
        ...
        are intended solely for the benefit of the parties and are not intended
