      ...
      <ul className="list-disc list-inside mb-6 text-gray-700">
        ...
        <li>
          ...
          <ul className="list-disc list-inside">
            <li>
              <a href="https://www.oregonlegislature.gov/bills_laws/ors/ors090.html">
                ORS 90 (as amended 2023)
              </a>
            </li>
            <li>
              <a href="https://www.oregonlegislature.gov/bills_laws/ors/ors105.html">
                ORS 105
              </a>
            </li>
            <li>
              <a href="https://eugene.municipal.codes/EC/8.425">
                Eugene Code Section 8.425
              </a>
            </li>
            <li>
              <a href="https://www.portland.gov/code/30/all">
