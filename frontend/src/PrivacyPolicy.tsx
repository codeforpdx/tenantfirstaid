  ...
  return (
    <div className="relative max-w-2xl m-auto p-8 bg-paper-background rounded-lg shadow-md">
      ...
      <p className="my-4">
        ...
        residents to access legal information free of charge about common tenant
        issues. This Privacy Policy explains how Qiu Qiu Law collects, uses, and
        discloses information about you through its websites and other online
      ...
      <p className="my-4">
        ...
        you to review the Privacy Policy whenever you access the Services or
      ...
      <p className="my-4">
        ...
        information, and generally do not need it to answer the type of general
        questions that Tenant First Aid is meant for.
      </p>
      <p className="my-4">
        However, if you choose to submit feedback through the feedback feature,
        you may be asked to include the conversation transcript. This
        ...
        provide it as part of your feedback submission. Any words or details you
        wish to protect can be redacted before submitting your feedback.
      </p>
      <p className="my-4">
      ...
      <ul className="list-disc list-outside my-4 pl-4">
        ...
        <li>
          ...
          most online services and mobile applications, we may use cookies and
          other technologies, such as web beacons and web storage to collect
          information about your activity, browser, and device. Cookies are
          small data files stored on your hard drive or in device memory that
          help us improve our Services and your experience, see which types of
          legal information are most frequently accessed through our Services,
          and count visits. Web beacons are electronic images that may be used
          in our Services or emails and help deliver cookies, count visits and
      ...
      <p>
        ...
        services, such as to track Service usage and improve the Services. We
        may also use the information we collect to:
      </p>
      <ul className="list-disc list-outside my-4 pl-4">
        <li>
        ...
        <li>
          Detect, investigate and prevent fraudulent and illegal activities and
          protect the rights and property of Tenant First Aid and others
        </li>
        <li>
      ...
      <ul className="list-disc list-outside my-4 pl-4">
        ...
        <li>
          With one of our legal services partner organizations, if you apply for
          legal aid
        </li>
        <li>
      ...
      <p className="my-4">
        ...
        and in applications. These entities may use cookies, web beacons, device
        identifiers and other technologies to collect information about your use
        of the Services and other websites and applications, including your IP
        ...
        This information may be used by Tenant First Aid and others to, among
        other things, analyze and track data, determine the popularity of
        certain content, deliver content targeted to your interests on our
        Services and other websites and better understand your online activity.
      </p>
      ...
      <p>
        Tenant First Aid is based in the United States and we process and store
