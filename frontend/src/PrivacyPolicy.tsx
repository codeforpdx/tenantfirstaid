      ...
      <div className="relative max-w-2xl m-auto p-8 bg-paper-background rounded-lg shadow-md">
        ...
        >
          <p>
            ...
            tenant issues. This Privacy Policy explains how Qiu Qiu Law
            collects, uses, and discloses information about you through its
            websites and other online products and services (collectively, the "
          ...
          <p>
            ...
            whenever you access the Services or otherwise interact with us to
        ...
        >
          ...
          <p>
            ...
            feature, you may be asked to include the conversation transcript.
            This information is used solely for debugging, product improvement,
            and developer support. We only collect this data when you
            voluntarily provide it as part of your feedback submission. Any
            words or details you wish to protect can be redacted before
          ...
          <ul className="list-disc list-outside pl-6">
            ...
            <li>
              ...
              cookies and other technologies, such as web beacons and web
              storage to collect information about your activity, browser, and
              device. Cookies are small data files stored on your hard drive or
              in device memory that help us improve our Services and your
              experience, see which types of legal information are most
              frequently accessed through our Services, and count visits. Web
            ...
            <li>
              Other Venders: Our Services connect with other technology
              platforms and anonymously shared/stored data is governed by their
              policies (Google:{" "}
              <Link
        ...
        >
          <p>
            ...
            our services, such as to track Service usage and improve the
            Services. We may also use the information we collect to:
          </p>
          <ul className="list-disc list-outside pl-6">
            <li>
        ...
        >
          <ul className="list-disc list-outside pl-6">
            <li>
              ...
              safety of Tenant First Aid or others
            </li>
            <li>
              Between and among Tenant First Aid and our partner organizations
              in order to provide, evaluate or improve the Services; and
            </li>
          ...
          <p>
            We may allow others to provide analytics services across the
            internet and in applications. These entities may use cookies, web
            ...
            information, pages viewed, time spent on pages or in apps, links
            clicked and conversion information. This information may be used by
            Tenant First Aid and others to, among other things, analyze and
        ...
        >
          <p>
            ...
            by interacting with the Services, or emailing us at{" "}
            <a
