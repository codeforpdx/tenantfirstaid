  ...
  return (
    <div className="flex items-center pt-16 sm:pt-32 sm:pb-16">
      <div className="relative max-w-2xl m-auto p-8 bg-paper-background rounded-none sm:rounded-lg shadow-md">
        ...
        >
          <p>
            <strong>Tenant First Aid</strong> is an AI-powered chatbot designed
            to help Oregon tenants navigate housing and eviction issues. It is a
          ...
          <p>
            ...
            help for renters facing eviction—quick, clear, and focused on what
            to do right now. Just like medical first aid helps stabilize someone
        ...
        >
          <p>
            Simply type your question or describe your situation, and Tenant
            First Aid will provide helpful information or direct you to relevant
            resources.
          </p>
        </PageSection>
        ...
        >
          <p>
            This chatbot provides general information about eviction law in
            Oregon and creates letters based on information provided by the
            user.
          </p>
          <p>
        ...
        >
          <p>
            ...
            through this chatbot is current, complete, or applies to your
            specific situation.
          </p>
        </PageSection>
        ...
        <PageSection title="No Liability" headingLevel={2}>
          <p>
            ...
            information from this chatbot. Use it at your own risk. Always
            double-check with a legal aid organization or attorney.
          </p>
        </PageSection>
      </div>
    </div>
