...
export default function About() {
  return (
    <div className="relative max-w-2xl m-auto p-8 bg-paper-background rounded-none sm:rounded-lg shadow-md">
      ...
      <p className="mb-6">
        Tenant First Aid does not store any personal data. All interactions are
        processed in real-time and not saved for future use.
      </p>
      <h2 className="text-2xl font-semibold mt-6 mb-2">
      ...
      <p>
        It is not legal advice, and using it does not create an attorney-client
        relationship. If you need legal advice or representation, you should
        contact a licensed attorney.
      </p>
      <h2 className="text-2xl font-semibold mt-6 mb-2">Information Accuracy</h2>
      <p className="mb-6">
