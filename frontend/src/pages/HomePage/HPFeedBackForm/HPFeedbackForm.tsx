  ...
  return (
    <section className="relative z-10 flex justify-center pb-[100px]">
      ...
      >
        ...
        <button
          type="submit"
          className="m-0 cursor-pointer border-none rounded-xl p-4 transition-all duration-200 ease-in-out hover:opacity-90 bg-[#E6D5B8]/70 text-[#4fff6e] text-[1.2rem] font-bold shadow-[0_4px_15px_rgba(16,185,129,0.3)]"
        >
          Submit
        </button>
      </form>
