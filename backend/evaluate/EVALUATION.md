...
| `VERTEX_AI_DATASTORE_LAWS` | yes | `tenantfirstaid-corpora_...` | Vertex AI Search datastore ID for the Oregon laws corpus |
...
2. Add each variable. For most, paste the value directly:
   ...
   | `VERTEX_AI_DATASTORE_LAWS` | `tenantfirstaid-corpora_...` |
