...
| `VERTEX_AI_DATASTORES` | yes | `[{"name":"laws","id":"tenantfirstaid-corpora_..."}]` | Vertex AI Search datastore configs |
...
2. Add each variable. For most, paste the value directly:
   ...
   | `VERTEX_AI_DATASTORES` | `[{"name":"laws","id":"tenantfirstaid-corpora_..."}]` |
